 ...
 * Features: TileMap, basic physics & actors
 **/


/**
 * @object_constructor KeyManager
 * Credit to Jonathan Roley for design layout for this object constructor
 **/
var KeyManager = (function() {
  ...
  KeyManager.prototype.stopRecording = function() {
      if (this.recording) {
          this.records.push(this.inputData.join(','));
          this.recording = false;
          this.inputData = [];
      }
  };
